# -*- coding: utf-8 -*-
"""
Created on Thu May 16 06:57:02 2019
...
#Section 1A-Scores with validation data with only one parameter(cv)
...
#Section 1B-Score with whole train data
...
cv_scores2 = model_selection.cross_val_score(dt2, X_train, y_train, cv=10)#cross_val for more than 2 params??
...
print(dt3_grid.best_params_)
print(dt3_grid.best_estimator_)
