# -*- coding: utf-8 -*-
"""
Created on Wed May 15 07:01:38 2019
...
titanic_test = pd.read_csv("C:/ML/test_titanic.csv")
...
titanic_test.to_csv("Submission_Grid_Params.csv", columns=['PassengerId', 'Survived'], index=False)